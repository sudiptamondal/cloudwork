...
class WatchListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watch_list" do
    assert_difference('WatchList.count') do
      post watch_lists_url, params: { watch_list: { have_it: @watch_list.have_it, title: @watch_list.title, type: @watch_list.type } }
    end
  ...
  test "should update watch_list" do
    patch watch_list_url(@watch_list), params: { watch_list: { have_it: @watch_list.have_it, title: @watch_list.title, type: @watch_list.type } }
